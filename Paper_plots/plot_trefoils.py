...
trefoil = np.load('trefoil_milnor_w=1d3_x=3d0_z=1d0_resXY=151_resZ=151.npy')
...
if 1:
	...
	# )
	fig = plot_torus(
		r_center=res//4 - 3, r_tube=res//10 + 6, fig=None, show=False, segments=100, rings=100, dots_bound=boundary_3D
	)
	...
	plot_line_colored(dots3[:-3], dots_bound=boundary_3D, show=False, color=color, width=25,
	                  fig=fig, save=None)
	# color = ([0, '#660000'], [1, '#ff0000'])
